...
def login(qq, pw):
    ...
    sign_url = "https://ssl.ptlogin2.qq.com/login?u={qq}&p={p}&verifycode={verify}&webqq_type=10&remember_uin=1&login2qq=1&aid=1003903&u1=http%3A%2F%2Fweb2.qq.com%2Floginproxy.html%3Flogin2qq%3D1%26webqq_type%3D10&h=1&ptredirect=0&ptlang=2052&daid=164&from_ui=1&pttype=1&dumy=&fp=loginerroralert&action=6-17-52584&mibao_css=m_webqq&t=1&g=1&js_type=0&js_ver=10116&login_sig=&pt_uistyle=5&pt_randsalt=0&pt_vcode_v1=0&pt_verifysession_v1={verifysession}".format(qq=qq, p=password, verify=verify.lower(), verifysession=verify_session)
